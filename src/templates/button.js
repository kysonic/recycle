...
AFRAME.registerTemplate('button', ({text='BUTTON', position='0 1 -2', rotation='0 0 0', event, color='red', textColor='white', width=1, height=0.5, opacity=1}) => `
    ...
    >
        <a-box 
            ...
            event-set__hoveron="_event: hover-start; material.opacity: ${opacity - 0.3}; transparent: true"
